...
def add_student(request):
    ...
    return render(request,"Home/students/add-student.html")

def student_list(request):
    query = request.GET.get('q')  # Capture the search query from GET request
    ...
    print("Filtered Students:", student_list)  # Debugging
    
    context = {
        'student_list': student_list,
        'query': query  # Pass query back to template
    }
    return render(request, "Home/students/students.html", context)
...
#  update student information
        ...
        return redirect("student_list")
    return render(request, "Home/students/edit-student.html",{'student':student, 'parent':parent} )
...
def view_student(request, slug):
    ...
    return render(request, "Home/students/student-details.html", context)
